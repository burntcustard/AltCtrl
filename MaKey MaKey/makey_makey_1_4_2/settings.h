...
// Inputs RIGHT TO LEFT when looking at the rear (header side) of the board:
...
// NOISE CANCELLATION /////
///////////////////////////
#define SWITCH_THRESHOLD_OFFSET_PERC  4   // number between 1 and 49
